...
// NBImageCache
#define COCOAPODS_POD_AVAILABLE_NBImageCache
#define COCOAPODS_VERSION_MAJOR_NBImageCache 0
#define COCOAPODS_VERSION_MINOR_NBImageCache 1
#define COCOAPODS_VERSION_PATCH_NBImageCache 0
